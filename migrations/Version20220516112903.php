 ...
 */
final class Version20220516112903 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE FULLTEXT INDEX IDX_C6AC3544FF7747B4 ON offres (titre)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_C6AC3544FF7747B4 ON offres');
    }
}
