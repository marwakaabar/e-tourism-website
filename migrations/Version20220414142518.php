 ...
 */
final class Version20220414142518 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offres ADD pays_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE offres ADD CONSTRAINT FK_C6AC3544A6E44244 FOREIGN KEY (pays_id) REFERENCES pays (id)');
        $this->addSql('CREATE INDEX IDX_C6AC3544A6E44244 ON offres (pays_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offres DROP FOREIGN KEY FK_C6AC3544A6E44244');
        $this->addSql('DROP INDEX IDX_C6AC3544A6E44244 ON offres');
        $this->addSql('ALTER TABLE offres DROP pays_id');
    }
}
